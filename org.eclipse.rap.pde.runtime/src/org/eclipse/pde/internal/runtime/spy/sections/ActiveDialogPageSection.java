		...
		if (object instanceof IPageChangeProvider) {
			...
			if (selectedPage != null) {
				...
				if (selectedPage instanceof IDialogPage) {
					...
					clazz = page.getClass();
					section.setText(NLS.bind(PDERuntimeMessages.get().SpyDialog_activeDialogPageSection_title, page.getTitle()));
				...
				buffer.append(toolkit.createClassSection(text, PDERuntimeMessages.get().SpyDialog_activeDialogPageSection_desc, new Class[] {clazz}));
