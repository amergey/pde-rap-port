...
public class PDERuntimePluginImages {
	...
	public static final ImageDescriptor CLASS_OBJ = create(PATH_OBJ,
			IMG_CLASS_OBJ);
	public static final ImageDescriptor INTERFACE_OBJ = create(PATH_OBJ,
			IMG_INTERFACE_OBJ);
	public static final ImageDescriptor PLUGIN_OBJ = create(PATH_OBJ,
			IMG_PLUGIN_OBJ);
	public static final ImageDescriptor SPY_OBJ = create(PATH_OBJ, IMG_SPY_OBJ);
	public static final ImageDescriptor MENU_OBJ = create(PATH_OBJ,
			IMG_MENU_OBJ);
	public static final ImageDescriptor ID_OBJ = create(PATH_OBJ, IMG_ID_OBJ);
	public static final ImageDescriptor MENUSPY_OBJ = create(PATH_OBJ,
			IMG_MENUSPY_OBJ);
	public static final ImageDescriptor CONTEXTID_OBJ = create(PATH_OBJ,
			IMG_CONTEXTID_OBJ);
	public static final ImageDescriptor SAVE_IMAGE_AS_OBJ = create(PATH_OBJ,
			IMG_SAVE_IMAGE_AS_OBJ);
	public static final ImageDescriptor COPY_QNAME = create(PATH_LCL,
			IMG_COPY_QNAME);

	public static final ImageDescriptor DESC_REFRESH_DISABLED = create(
			PATH_DCL, "refresh.gif"); //$NON-NLS-1$
	...
	public static final ImageDescriptor DESC_ATTR_XML_OBJ = create(PATH_OBJ,
			"attr_xml_obj.gif"); //$NON-NLS-1$
	...
	public static final ImageDescriptor DESC_IMP_OBJ = create(PATH_OBJ,
			"bundle-importer.gif"); //$NON-NLS-1$
	public static final ImageDescriptor DESC_EXP_OBJ = create(PATH_OBJ,
			"bundle-exporter.gif"); //$NON-NLS-1$
	...
	public static final ImageDescriptor DESC_PLUGINS_OBJ = create(PATH_OBJ,
			"plugins_obj.gif"); //$NON-NLS-1$
	public static final ImageDescriptor DESC_FRAGMENT_OBJ = create(PATH_OBJ,
			"frgmt_obj.gif"); //$NON-NLS-1$
	...
	public static final ImageDescriptor DESC_DEFAULT_CO = create(PATH_OVR,
			"default_co.gif"); //$NON-NLS-1$
	...
	public static Image get(String key) {
		ImageRegistry registry = PDERuntimePlugin.getDefault()
				.getImageRegistry();
	...
	private static URL makeIconURL(String prefix, String name) {
		...
		return FileLocator.find(PDERuntimePlugin.getDefault().getBundle(),
				new Path(path), null);
	}
